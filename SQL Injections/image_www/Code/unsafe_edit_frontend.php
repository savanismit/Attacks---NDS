...
<head>
  ...
  <!-- Browser Tab title -->
  <title>ZeeAttackers</title>
</head>

<body style="color: whitesmoke">
  <nav class="navbar fixed-top navbar-expand-lg navbar-light" style="background-color: #3EA055;">
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      <a class="navbar-brand" href="unsafe_home.php" style="color:whitesmoke; margin:0; padding:0"><img src="logo.png" style="height: 60px; width: 70px;" alt="ZeeAttackers"></a>
      <ul class='navbar-nav mr-auto mt-2 mt-lg-0' style="color:whitesmoke; margin:0; padding:0; padding-left: 30px;">
        <li class='nav-item'>
